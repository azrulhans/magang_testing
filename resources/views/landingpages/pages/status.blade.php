...
<div class="content-wrapper">
          <div class="card">
            <div class="card-header" style="background-color: #007bff; text-align: center">
                <h2 class="card-title" style="color: #fff; font-family: inherit;">Data Diri</h2>
                <p style="color: #fff; font-family: inherit;">Data Anda Berhasil Disimpan</p>
            </div>
        ...
        @endforeach
<button onclick="history.back()"style="background-color: #007bff; color:white; " class="btn btn-light mt-3">Kembali</button>
        </div>
</div>
@endsection